...
def start_page():  # Starting page, choose number
    print('╔' + 48 * "═" + '╗')
    print('            \033[3;36mСписок Дел v1.0\033[0m')
    print('╚' + 48 * "═" + '╝')
    print(main_menu)
    print(50 * "═")
...
def show_deals(data):  # 1 в меню, показывает список всех дел и преобразует ключ в статус дела
...
def change_deal_content(one_deal):
    while True:
        ...
        if command == '1':
            ...
            status = input('1-Новое, 2-В работе, 3-Отложенное, 4-Просроченное, 5-Выполненное\n')
